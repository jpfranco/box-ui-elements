...
type Props = {
    ...
    isRestrictionJustificationAllowed?: boolean,
...
const ContactRestrictionNotice = ({
    ...
    isRestrictionJustificationAllowed,
    ...
    const restrictionNoticeMessage = isRestrictionJustificationAllowed
        ? messages.justifiableContactRestrictionNotice
        : messages.contactRestrictionNotice;
    const removeButtonLabelMessage = isRestrictionJustificationAllowed
    ...
    return (
        <Tooltip text={error} isShown={isErrorTooltipShown} position="middle-right" theme="error">
            ...
            >
                ...
                />
                {isRestrictionJustificationAllowed && justificationSelectSection}
                <PlainButton
